...
const CheapData = () => {
  ...
  const dataPlans = {
    mtn: [
      { name: 'MTN 500MB SME - 30 Days ₦160' },
      { name: 'MTN 1GB SME - 30 Days ₦290' },
      { name: 'MTN 2GB SME - 30 Days ₦580' },
      { name: 'MTN 3GB SME - 30 Days ₦870' },
      { name: 'MTN 5GB SME - 30 Days ₦1450' },
      { name: 'MTN 10GB SME - 30 Days ₦2900' },
    ],
    airtel: [
      { name: 'AIRTEL 500MB SME - 30 Days ₦150' },
      { name: 'AIRTEL 1GB SME - 30 Days ₦280' },
      { name: 'AIRTEL 2GB SME - 30 Days ₦560' },
      { name: 'AIRTEL 3GB SME - 30 Days ₦850' },
      { name: 'AIRTEL 5GB SME - 30 Days ₦1400' },
      { name: 'AIRTEL 10GB SME - 30 Days ₦2800' },
    ],
    '9mobile': [
      { name: '9MOBILE 500MB SME - 30 Days ₦170' },
      { name: '9MOBILE 1GB SME - 30 Days ₦300' },
      { name: '9MOBILE 2GB SME - 30 Days ₦600' },
      { name: '9MOBILE 3GB SME - 30 Days ₦900' },
      { name: '9MOBILE 5GB SME - 30 Days ₦1500' },
      { name: '9MOBILE 10GB SME - 30 Days ₦3000' },
    ],
    glo: [
      { name: 'GLO 500MB SME - 30 Days ₦180' },
      { name: 'GLO 1GB SME - 30 Days ₦320' },
      { name: 'GLO 2GB SME - 30 Days ₦640' },
      { name: 'GLO 3GB SME - 30 Days ₦950' },
      { name: 'GLO 5GB SME - 30 Days ₦1600' },
      { name: 'GLO 10GB SME - 30 Days ₦3200' },
    ],
  };
